...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if ([userDefaults boolForKey:NotRecallTabbar]) {
        ...
        tabbarBg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"tabbar_bg"]];
        selectedTab = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 64, 50)];
...
- (void)customTabBar
{
    ...
    [slideBg setFrame:CGRectMake(0, YOFFSET, 64, 50)];
...
- (void)setSelectedTabWithoutAnimation:(NSUInteger)index
{
    currentSelectedIndex = index;
    self.selectedIndex = currentSelectedIndex;
    slideBg.frame = CGRectMake(self.selectedIndex * 64, YOFFSET, 64, 50);
